...
var app = angular.module("onlineCPS");
  ...
  var raiseRequestController = function($scope, $http, $timeout, $log, session,raiseRequestService,$routeParams){
    ...
    raiseRequestService.yearList().then(function (response) {
    ...
    */
    ...
    raiseRequestService.electiveYearList("1",sid).then(function (response) {
      $scope.e1c1 = response[0];
      $scope.e1c1year = response[0].term;
      //console.log(response);
    });
    
    raiseRequestService.electiveYearList("2",sid).then(function (response) {
      $scope.e2c1 = response[0];
      $scope.e2c1year = response[0].term;
      //console.log(response);
    });
    
    raiseRequestService.electiveYearList("3",sid).then(function (response) {
      $scope.e3c2 = response[0];
      $scope.e3c2year = response[0].term;
      //console.log(response);
    });
    
    raiseRequestService.electiveYearList("4",sid).then(function (response) {
      $scope.e4c2 = response[0];
      $scope.e4c2year = response[0].term;
      //console.log(response);
    });
    
    raiseRequestService.electiveYearList("5",sid).then(function (response) {
      $scope.e5c1 = response[0];
      $scope.e5c1year = response[0].term;
      //console.log(response);
    });
    
    raiseRequestService.electiveYearList("6",sid).then(function (response) {
    ...
    raiseRequestService.electiveDepartment("1",sid).then(function (response) {
      $scope.e1c1dept = response[0].rubric;
      $scope.e1c1d();
      //console.log(response);
    });
    
    raiseRequestService.electiveDepartment("2",sid).then(function (response) {
      $scope.e2c1dept = response[0].rubric;
      $scope.e2c1d();
      //console.log(response);
    });
    
    raiseRequestService.electiveDepartment("3",sid).then(function (response) {
      $scope.e3c2dept = response[0].rubric;
      $scope.e3c2d();
      //console.log(response);
    });
    
    raiseRequestService.electiveDepartment("4",sid).then(function (response) {
      $scope.e4c2dept = response[0].rubric;
      $scope.e4c2d();
      //console.log(response);
    });
    
    raiseRequestService.electiveDepartment("5",sid).then(function (response) {
      $scope.e5c1dept = response[0].rubric;
      $scope.e5c1d();
      //console.log(response);
    });
    
    raiseRequestService.electiveDepartment("6",sid).then(function (response) {
      $scope.e6c1dept = response[0].rubric;
      $scope.e6c1d();
      //console.log(response);
    });
    
    raiseRequestService.courseCompletionGetData("1",sid).then(function (response) {
      console.log(response);
    ...
    raiseRequestService.courseCompletionGetData("2",sid).then(function (response) {
    ...
    $scope.e1c1d = function(){
        ...
        $scope.e1c1subList = [];
        raiseRequestService.elective($scope.e1c1year,$scope.e1c1dept,5030,6939,1,sid).then(function (response) {
    ...
    */
    ...
    $scope.e2c1d = function(){
        ...
        $scope.e2c1subList = [];
        raiseRequestService.elective($scope.e2c1year,$scope.e2c1dept,5030,6939,2,sid).then(function (response) {
    ...
    $scope.e3c2d = function(){
        ...
        $scope.e3c2subList = [];
        raiseRequestService.elective($scope.e3c2year,$scope.e3c2dept,5030,6939,3,sid).then(function (response) {
    ...
    $scope.e4c2d = function(){
        ...
        $scope.e4c2subList = [];
        raiseRequestService.elective($scope.e4c2year,$scope.e4c2dept,4030,6939,4,sid).then(function (response) {
    ...
    $scope.e5c1d = function(){
        ...
        $scope.e5c1subList = [];
        raiseRequestService.elective($scope.e5c1year,$scope.e5c1dept,4030,6939,5,sid).then(function (response) {
    ...
    $scope.e6c1d = function(){
        ...
        $scope.e6c1subList = [];
        raiseRequestService.elective($scope.e6c1year,$scope.e6c1dept,5030,6939,6,sid).then(function (response) {
    ...
    //session.updateSessionWithUrl("/requestFromAdvisor");
    $scope.space = " ";
    $scope.foundation = "";
    $scope.coreSub = "";
    
    //fetch foundation courses
    raiseRequestService.foundation(sid).then(function (response) {
      $scope.foundation = response;
      console.log(response);
    });
    
    //fetch core courses
    raiseRequestService.coreSub(sid).then(function (response) {
      ...
      $scope.request = function(){
        ...
        if(toastCount==0){
          ...
          //create request
              ...
              raiseRequestService.createRequest(requestTime,sid).then(function (response) {
            ...
            var foundationsRequest = function(){
                  ...
                  for (var n = 0 ; n < $scope.foundation.length ; ++n){
                    ...
                    raiseRequestService.createFoundationRequest(requestId,$scope.foundation[n].foundationYear,$scope.foundation[n].selected,n,sid).then(function (response) {
                      console.log(response);
            ...
            var coreRequest = function(){
                  ...
                  for (var n = 0 ; n < $scope.coreSub.length ; ++n){
                    ...
                    raiseRequestService.createCoreRequest(requestId,$scope.coreSub[n].coreYear,$scope.coreSub[n].rubric,$scope.coreSub[n].number,n, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
              ...
              succesCall();
               ...
               var electiveRequestOne = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e1c1year,$scope.e1c1sub,1, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
               ...
               var electiveRequestTwo = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e2c1year,$scope.e2c1sub,2, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
               ...
               var electiveRequestThree = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e3c2year,$scope.e3c2sub,3, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
          ...
          var electiveRequestFour = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e4c2year,$scope.e4c2sub,4,sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
          ...
          var electiveRequestFive = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e5c1year,$scope.e5c1sub,5, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
            ...
            var electiveRequestSix = function(){
                  ...
                  //submit elective term, requestid, elective Course ID (COURSE ID: # CSCI4306)
                    ...
                    raiseRequestService.createElectiveRequest(requestId,$scope.e6c1year,$scope.e6c1sub,6, sid).then(function (response) {
                      console.log(response);
                      var $toastContent = $('<span>'+response+'</span>');
                      Materialize.toast($toastContent, 10000,"green");
                    });
          ...
          //submit theses / capst
            ...
            var courseCompletionRequest = function(){
                  ...
                  raiseRequestService.courseCompletionRequest(requestId,$scope.ccYear,$scope.ccSub,1, sid).then(function (response) {
                        console.log(response);
                        var $toastContent = $('<span>'+response+'</span>');
                        Materialize.toast($toastContent, 10000,"green");
                      });
                  ...
                  if($scope.ccSub == 2){
                    //we need to request for Capstone
                      ...
                      raiseRequestService.courseCompletionRequest(requestId,$scope.cct2Year,$scope.ccSub,2, sid).then(function (response) {
                        console.log(response);
                        var $toastContent = $('<span>'+response+'</span>');
                        Materialize.toast($toastContent, 10000,"green");
                      });
  ...
  app.controller("raiseRequestController",raiseRequestController);

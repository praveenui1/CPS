(function() {
  ...
  app.service('studentHistoryService', function($log, $rootScope, $http, $location) {

    this.getRequests = function(keyword) {
     ...
     var getDateNow = function(dateChange){
            return new Date(parseInt(dateChange,10)).toLocaleDateString('en-US');
        }
    
    
    this.finalCPS = function (sid) {
